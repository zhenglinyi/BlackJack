...
public class NetManager : ManagerBase
{
    ...
    HandlerBase singleHandler = new SingleFightHandler();
    HandlerBase multiHandler = new MultiFightHandler();
    ...
    private void processSocketMsg(SocketMsg msg)
    {
        switch (msg.OpCode)
        {
            ...
            case OpCode._21Single:
                singleHandler.OnReceive(msg.SubCode, msg.Value);
                break;
            case OpCode._21Multi:
                multiHandler.OnReceive(msg.SubCode, msg.Value);
                break;
            default:
                break;
        }
